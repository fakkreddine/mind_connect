...
import { Brain, Calendar, Home, LogOut, MessageSquare, Settings, User, Video } from "lucide-react"
      ...
      <div className="flex min-h-screen">
        <Sidebar>
          <SidebarHeader className="flex items-center justify-between">
            <Link href="/patient/dashboard" className="flex items-center gap-2 px-2">
